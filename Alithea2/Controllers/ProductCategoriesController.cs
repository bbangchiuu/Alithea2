...
namespace Alithea2.Controllers
{
    public class ProductCategoriesController : Controller
    {
        ...
        {
            ViewBag.CategoryID = new SelectList(db.Categories, "CategoryID", "RoleNumber");
            ViewBag.ProductID = new SelectList(db.Products, "ProdcutID", "RoleNumber");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ID,ProductID,CategoryID")] ProductCategory productCategory)
        {
            ...
            ViewBag.CategoryID = new SelectList(db.Categories, "CategoryID", "RoleNumber", productCategory.CategoryID);
            ViewBag.ProductID = new SelectList(db.Products, "ProdcutID", "RoleNumber", productCategory.ProductID);
            return View(productCategory);
        }
